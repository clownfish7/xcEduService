...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4() {
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:\\ffmpeg-20190616-1c3ed11-win64-static\\bin\\ffmpeg.exe";
        //video_path视频地址
        String video_path = "F:\\y2y\\video\\processBuilder\\01-在线学习需求分析.avi";
        //mp4_name mp4文件名称
        String mp4_name = "1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path = "F:\\y2y\\video\\processBuilder\\";
